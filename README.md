...
|------------|-------------|
| <p align="center"/><img src="screenshots/mainsn.png" alt="Main Screen" width="250"/> | *Main Screen* contains buttons to fetch JSON data from web API and view stored data in RecyclerView. |
